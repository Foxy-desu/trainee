...
const TaskCard = ({ cardData, editForm, handlers }) => {
  ...
  const getEditBtnHandler = (editMode, handlers) => {
    return editMode ? handlers.save : handlers.edit;
  };
    ...
    <article className={cl.card}>
      <div className={cl.statusBar}>
        <div className={cl.info}>
          <div>
            <span
              className={`${cl.status} ${isComplete ? cl.complete : cl.incomplete}`}
            >
          ...
          <div>
            {!editForm.editMode && (
              <span
                className={`${cl.deadline} ${isComplete ? cl.inactive : cl.active}`}
              >
        ...
        <div className={cl.controlls}>
          <div className={cl.btnsWrap}>
            <MyOperateBtn purpose="remove" onClick={handlers.remove} />
            <MyOperateBtn
      ...
      <div className={cl.taskDescription}>
        {editForm.editMode ? (
          ...
          <>
            <MyTaskTitle title={cardData.title} />
            <MyTaskDescription desc={cardData.description} />
          </>
        )}
      </div>
    </article>
